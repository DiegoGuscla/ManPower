 ...
 * @author diego
 */
public class ModelsListView extends javax.swing.JInternalFrame {
    ...
    public ModelsListView() {
        ...
        listTable.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent mouseEvent) {
                ...
                if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {                    
                    openRegisterModelView(String.valueOf(
        ...
        try {
            //Busca lista
            loadModelsList(getModelsDAO().getModels());
        } catch (SQLException ex) {
            getDialoBox().showDialogBox("Erro ao buscar lista de Modelos!"
    ...
    private void openRegisterModelView(String modelId) {
        registerModelView = new RegisterModelView(modelId);
        registerModelView.addInternalFrameListener(new InternalFrameAdapter(){
            @Override
            public void internalFrameClosing(InternalFrameEvent e) {
                enableContributorsListView();
                registerModelView.removeAll();
        ...
        desktopPane.add(registerModelView);
        registerModelView.toFront();
        registerModelView.setSize(1200, 400);
        registerModelView.setPreferredSize(new Dimension(1200, 400));
        registerModelView.setPosition(desktopPane);
        
        registerModelView.setVisible(true);
    ...
    private void loadModelsList(ArrayList<Model> models) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("ManPower - Lista de Modelos");
