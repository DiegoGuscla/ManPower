 ...
 * @author diego
 */
public class RegisterManufacturerView extends javax.swing.JInternalFrame {
    ...
    public RegisterManufacturerView(String manufacturerId) {
        try {
        ...
        if (!manufacturerId.isEmpty()) {
            try {
                loadManufacturer(getManufacturersDAO().getManufacturer(manufacturerId));
            } catch (SQLException ex) {
                getDialoBox().showDialogBox("Erro ao carregar dados do fabricante! Erro: "
                        + ex.getMessage(), "Atenção!");
            }
        }
    }
    
    private void loadManufacturer(Manufacturer manufacturer) {
        ...
        codTextField.setText(String.valueOf(manufacturer.getId()));
        nameTextField.setText(manufacturer.getName());
        codeTextField.setText(manufacturer.getCode());
    }
    ...
    *Checa campos de entrada e salva colaborador
    ...
    private void saveManufacturer() {
        ...
        try {
            Integer id = getManufacturersDAO().saveManufacturer(propertiesList);
            if (codTextField.getText().isEmpty())
            ...
            getDialoBox().showDialogBox("Erro ao salvar Fabricante! "
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("ManPower Preparação - Registro de Fabricantes");
